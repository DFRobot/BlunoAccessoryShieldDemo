...
public class ProgressWheel extends View {
	...
	//Sizes (with defaults)
	public int fullRadius = 100;
	public int circleRadius = 80;
	...
	public RectF circleBounds = new RectF();
...
//		canvas.drawArc(circleBounds, 360, 360, false, rimPaint);
		...
		if(isSpinning) {
			...
			canvas.drawArc(circleBounds, -225, progress, false, barPaint);
		}
	...
	public int getDrawingX() {
		return (int) ((circleBounds.width()/2) + rimWidth + paddingLeft);
	}
	public int getDrawingY() {
		return (int) ((circleBounds.height()/2) + rimWidth + paddingTop);
	}
